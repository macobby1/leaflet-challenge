...
function createMap(earthquakes) {
    ...
    var outdoors = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/outdoors-v10/tiles/256/{z}/{x}/{y}?" +
      "access_token=pk.eyJ1IjoibWFjb2JieSIsImEiOiJja2Fla2NyZzUwMXhwMnNwOXdnMDFqdGYzIn0.xjxXIyJH10OOt3-sXtkuyg." +
    ...
    // Create map, giving it the outdoors, earthquakes and tectonic plates layers to display on load
    var myMap = L.map("map", {
      center: [
        37.09, -95.71],
      zoom: 3.25,
    ...
    d3.json(tectonicPlatesURL, function(plateData) {
      // Add geoJSON data, along with style information, to the tectonicplates
      // layer.
      L.geoJson(plateData, {
        color: "red",
        weight: 2
